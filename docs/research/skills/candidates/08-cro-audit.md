# Skill Audit — CRO Audit

## Metadata

| Field | Value |
|-------|-------|
| **Card ID** | `SKILL-AUDIT-008` |
| **Marketsynth ID** | `MS-SKILL-010` |
| **Candidate name** | CRO Audit |
| **Source URL / repo** | https://github.com/coreyhaines31/marketingskills/tree/main/skills/cro |
...
Conversion-focused page and funnel audit recommendations.
...
| Question | Answer |
|----------|--------|
| CWF step strengthened | Launch Pack / Content (post-verdict optimization) |
| User-visible result | Secondary to first paying validation workflow — valuable after Launch Pack live. |
...
Launch Pack / Content (post-verdict optimization)

### Expected commercial value

Secondary to first paying validation workflow — valuable after Launch Pack live.

---

## 4. Methodology

CRO frameworks for pages/forms; cross-links copywriting and ab-testing skills.
...
- Fetch connector read-only
- Analytics tools — **Defer** until MCP audited
...
Post-CWF.1a content optimization subskill; no auto-apply changes.
...
Medium via fetched page content.
...
Repo evals claimed globally — **Requires technical validation**.
...
| Decision | **Adapt** |
|----------|----------------|
| **Rationale** | P1 enhancement; adapt as checklist operator after core CWF path accepted. |
| **Required modifications** | - Read-only fetch + human-approved recommendations only |
| **Defer unblock condition** | After CWF.1 Launch Pack owner acceptance |
