# Skill Audit — Competitor Analysis

## Metadata

| Field | Value |
|-------|-------|
| **Card ID** | `SKILL-AUDIT-003` |
| **Marketsynth ID** | `MS-SKILL-003` |
| **Candidate name** | Competitor Analysis |
| **Source URL / repo** | https://github.com/coreyhaines31/marketingskills/tree/main/skills/competitors + skills/competitor-profiling |
| **Author / vendor** | Corey Haines |
| **License** | MIT |
| **Version reviewed** | Not verified per-folder — repo main branch |
...
Competitive landscape and comparison/alternative page planning for SEO and sales enablement.
...
| User-visible result | Supports verdict-grade competitor evidence in BIV and Launch Pack positioning. |
...
Supports verdict-grade competitor evidence in BIV and Launch Pack positioning.

---

## 4. Methodology

`competitors`: comparison page frameworks, positioning gaps. `competitor-profiling`: URL-based profiling workflow. Expects product-marketing context.
...
- Tools: read-only fetch/search (Firecrawl/XmlRiver)
...
Fits research operator substep; outputs are **candidates** until Evidence admission. No auto-verdict.
...
Medium prompt injection via competitor page content. Bounded egress via fetch adapter only.
...
Informal templates; repo-level evals claimed — **Not verified** for competitors skill specifically.
...
Methodology Adapt; direct install Reject.
...
| Decision | **Adapt** |
|----------|----------------|
| **Rationale** | Valuable frameworks; Marketsynth already has research collection — integrate as internal subskill prompts/checklists, not external activation. |
| **Required modifications** | - Merge profiling + comparison into single MS operator
- Mandatory source URLs + fetch snapshots
- Block unsourced competitor claims in verdict mapper |
...
- https://github.com/coreyhaines31/marketingskills/tree/main/skills/competitors
- https://github.com/coreyhaines31/marketingskills/tree/main/skills/competitor-profiling
