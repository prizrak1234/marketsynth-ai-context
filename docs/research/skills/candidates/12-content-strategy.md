...
| Field | Value |
|-------|-------|
| **Card ID** | `SKILL-AUDIT-012` |
| **Marketsynth ID** | `MS-SKILL-014` |
| **Candidate name** | Content Strategy |
| **Source URL / repo** | https://github.com/coreyhaines31/marketingskills/tree/main/skills/content-strategy |
...
Plan topics, pillars, and content calendar aligned to ICP and funnel stage.
...
| User-visible result | Supports 3 Content Assets and launch planning. |
...
Supports 3 Content Assets and launch planning.

---

## 4. Methodology

Topic prioritization, funnel mapping, ties to customer-research and SEO skills.
...
| Decision | **Adapt** |
|----------|----------------|
| **Rationale** | Natural Launch Pack extension after CWF.1a accepted. |
| **Required modifications** | - Persist as Launch Pack content scope contract |
| **Defer unblock condition** | After CWF.1a owner acceptance |
