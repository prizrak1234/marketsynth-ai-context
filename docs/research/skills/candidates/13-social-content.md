# Skill Audit — Social Content

## Metadata

| Field | Value |
|-------|-------|
| **Card ID** | `SKILL-AUDIT-013` |
| **Marketsynth ID** | `MS-SKILL-015` |
| **Candidate name** | Social Content |
| **Source URL / repo** | https://github.com/coreyhaines31/marketingskills/tree/main/skills/social |
...
Create social posts and short-form content variants.
...
| Question | Answer |
|----------|--------|
| CWF step strengthened | Content Assets → Telegram |
| User-visible result | Feeds Telegram publication packages in CWF.1. |
...
Content Assets → Telegram

### Expected commercial value

Feeds Telegram publication packages in CWF.1.

---

## 4. Methodology

Platform-aware social copy frameworks.

### Required inputs

- Content pillar
- Brand voice
- Channel (Telegram focus)
...
Publication package input — must use frozen Telegram publish path, not MCP.
...
Copy quality depends on context.
...
| Decision | **Adapt** |
|----------|----------------|
| **Rationale** | Align with native publication foundation; no social MCP auto-post. |
| **Required modifications** | - Output → PublicationPackage draft only
- Human approval before send |
| **Defer unblock condition** | After Telegram publish slice in CWF |
