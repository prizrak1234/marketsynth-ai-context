# Skill Audit — Video Content Brief

## Metadata

| Field | Value |
|-------|-------|
| **Card ID** | `SKILL-AUDIT-016` |
| **Marketsynth ID** | `MS-SKILL-020` |
| **Candidate name** | Video Content Brief |
| **Source URL / repo** | https://github.com/coreyhaines31/marketingskills/tree/main/skills/video |
...
Brief for short-form video and UGC-style scripts before generation.
...
| Question | Answer |
|----------|--------|
| CWF step strengthened | Optional Visuals / Video Studio track |
| User-visible result | Aligns with Video Studio constitution — brief-only in CWF.1 scope. |
...
Optional Visuals / Video Studio track

### Expected commercial value

Aligns with Video Studio constitution — brief-only in CWF.1 scope.

---

## 4. Methodology

Video/script brief frameworks; references generation — gated.

### Required inputs

- Offer/message
- Platform (Telegram vertical video etc.)
- Duration constraints

### Expected outputs

- Script + shot list brief
...
- Video generation providers (Higgsfield / internal Video Studio)
...
Video Studio preview path — no auto-publish.
...
Same as visual — generation gated.
...
MIT; vendor content terms **Unknown**.
...
| Decision | **Adapt** |
|----------|----------------|
| **Rationale** | Brief internalizable; keep separate from VS.1 smoke execute gates. |
| **Required modifications** | - Map to Video Studio contracts
- No auto-execute without explicit_confirmation |
| **Defer unblock condition** | Video Studio owner acceptance |
