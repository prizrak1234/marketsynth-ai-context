# Skill Audit — ICP and Segmentation

## Metadata

| Field | Value |
|-------|-------|
| **Card ID** | `SKILL-AUDIT-004` |
| **Marketsynth ID** | `MS-SKILL-004` |
| **Candidate name** | ICP and Segmentation |
| **Source URL / repo** | https://github.com/coreyhaines31/marketingskills/tree/main/skills/customer-research (personas) + product-marketing (audience sections) |
| **Author / vendor** | Corey Haines |
| **License** | MIT |
| **Version reviewed** | 2.0.1 / 2.1.0 |
...
Define ICP, segments, and personas grounded in research — not invented demographics.
...
| Question | Answer |
|----------|--------|
| CWF step strengthened | Research → Verdict inputs |
| User-visible result | Improves verdict quality and Launch Pack targeting — core to willingness-to-pay for validation workflow. |
...
Improves verdict quality and Launch Pack targeting — core to willingness-to-pay for validation workflow.

---

## 4. Methodology

Persona template with JTBD, triggers, pains, vocabulary; anti-patterns (no cute names, no averaging). Minimum 5–10 data points per segment.

### Required inputs

- Research synthesis or raw quotes
- Product context
- Segment hypothesis (optional)

### Expected outputs

- 1–3 persona documents
- Segment boundaries
- Anti-persona notes
...
- Depends on MS-SKILL-002 outputs or admitted Evidence
...
Internal subskill post-research; feeds BIV audience modules. Approval before customer-facing persona export.
...
Low direct risk; medium if built on unverified scraped text.
...
Explicit sample minimums and confidence — good fit for Evidence contract.
...
| Decision | **Adapt** |
|----------|----------------|
| **Rationale** | Marketsynth needs governed segmentation artifacts tied to Evidence, not chat-generated personas. |
| **Required modifications** | - Persist personas as typed contracts
- Block persona generation below evidence threshold
- Link each persona field to source IDs |
...
- customer-research SKILL.md persona section
- product-marketing audience sections
