...
Canonical documents are normalized into:
...
Historical uploaded package folders are preserved under `archive/imported-packs/` and are not the primary Source of Truth.
